...
export const register = async (req, res) => {
  ...
  if (
    ...
    !dateOfBirth ||
    !address ||
    (role.toLowerCase() === "teacher" && (!subjects || subjects.length === 0))
  ) {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "Account Created For TeachGrid",
      html: NEW_USER_REGISTRY(name, email),
    };
    ...
    const mailOptions = {
      ...
      html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; border: 1px solid #eee;">
                    ...
                    <p>Note: This OTP expires in <b>15 minutes</b>.</p>
                    <hr />
